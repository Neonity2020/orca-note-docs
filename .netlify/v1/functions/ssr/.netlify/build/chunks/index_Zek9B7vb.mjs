const id = "index.mdx";
					...
					},actions:[{text:"开始使用",link:"/zh-cn/guides/introduction/",variant:"primary",icon:{type:"icon",name:"right-arrow"}},{text:"阅读官方手册",link:"https://www.orca-studio.com/",variant:"minimal",icon:{type:"icon",name:"external"}}]},sidebar:{hidden:false,attrs:{}},pagefind:true,draft:false};
						const _internal = {
							type: 'content',
							filePath: "/Users/andi/Documents/GitHub/orca-note-docs/src/content/docs/index.mdx",
							rawData: undefined,
						};
